...
export default function LoginPage({ onBack, onSuccess, onSwitchToSignup }: LoginPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#FAFBFD] text-neutral-900 font-sans relative flex items-center justify-center p-4 sm:p-6 overflow-hidden" id="login-page-root">
