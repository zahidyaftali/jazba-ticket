    ...
    steps: [
      {
        ...
        body: "Search by artist, venue, city or date — every listing is verified before it goes on sale.",
      },
      {
        step: "02",
        title: "Pay your way",
        body: "Checkout detects your location and shows local prices and payment methods automatically.",
      },
      {
        step: "03",
        title: "Walk straight in",
        body: "Your barcode lands in your inbox and dashboard instantly. Show it at the door — printed or on your phone.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        body: "Apply with your profile, past shows and streaming links. We verify every performer personally.",
      },
      {
        step: "02",
        title: "Set one flat fee",
        body: "You decide what a night of your work costs — per event, never per hour. No hidden deductions.",
      },
      {
        step: "03",
        title: "Play, then get paid",
        body: "We hold the booking fee in escrow and release it straight after the show. On time, every time.",
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        body: "Create your show in minutes — venue, dates, ticket tiers and pricing, all from one dashboard.",
      },
      {
        step: "02",
        title: "Sell everywhere",
        body: "Your event appears across the platform with secure checkout in your buyers' local currency.",
      },
      {
        step: "03",
        title: "Track in real time",
        body: "Live sales, scans at the gate, and revenue reports — with payouts on a schedule you can plan around.",
      },
    ],
  },
];
...
const GUARANTEES = [
  ...
  "UK-based support — Mon–Fri, 10:30am–5:30pm on +44(0)3335777014",
];
...
export default function AboutPage() {
  ...
  return (
    <div
      className="jz-page bg-white min-h-screen text-black"
      id="about-page-root"
    >
      ...
      <section className="relative bg-[#121212] min-h-[420px] h-[60vh] px-4 sm:px-6 md:px-8 overflow-hidden z-10 flex items-center">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10 text-left space-y-4">
          ...
          <p className="text-neutral-300 font-normal text-sm sm:text-base md:text-lg max-w-2xl leading-relaxed">
            ...
            the artists behind them directly for your own event.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
          {STATS.map((s) => (
            <div key={s.label}>
              ...
              <div className="text-sm font-medium text-black/70 mt-2">
                {s.label}
              </div>
            </div>
          ))}
      ...
      <section className="px-4 sm:px-6 md:px-8 py-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 text-base text-[#222] leading-relaxed space-y-5">
            ...
            <p>
              We work across live music events and festivals, artist management,
              music publishing, and music distribution, with recording studios
              in Birmingham and Lahore, and film production equipment available
              for hire in Islamabad. Alongside our production and management
              work, we also provide graphics and web design, and social media
            ...
            <p>
              ...
              <strong className="font-bold">
                to book the artists behind them directly for your own event.
              </strong>
            </p>
          </div>
        </div>
              ...
              <div key={group.audience}>
                ...
                <div>
                  {group.steps.map((s) => (
                    <div
                      key={s.step}
                      className="flex gap-5 py-5 border-b border-white/15 last:border-b-0"
                    >
                      <span className="font-display font-bold text-lg text-[#ffed00] shrink-0">
                        {s.step}
                      </span>
                      <div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5">
            ...
            <p className="text-base text-[#222] leading-relaxed mt-5 max-w-md">
              ...
              — printed on your receipt, honoured at the gate.
            </p>
          </div>
          <div className="lg:col-span-7 border-t border-[#f2f2f2]">
            {GUARANTEES.map((g) => (
              <div
                key={g}
                className="flex items-center gap-4 py-5 border-b border-[#f2f2f2]"
              >
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
            ...
            <p className="text-black/70 text-sm mt-4 max-w-md">
              Browse tonight's shows, book the artist for your own event, or get
              in touch at support@jazbatickets.com or +44(0)3335777014 —
