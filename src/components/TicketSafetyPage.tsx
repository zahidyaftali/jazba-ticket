...
const SECTIONS: Array<{
...
}> = [
  {
    ...
    body: (
      <p>
        ...
        marketplaces, or unknown third parties.
      </p>
    ),
  },
  {
    ...
    body: (
      <ul className="list-disc pl-5 space-y-2.5">
        ...
        <li>
          Genuine tickets carry a unique QR code tied to your order — this is
  ...
  },
  {
    ...
    body: (
      <p>
        If you can no longer attend an event, please use our Refund Policy or
        transfer options rather than reselling on third-party sites — tickets
        resold above face value, or through unofficial channels, are not
        guaranteed and may be refused entry. Where an event allows it, official
        ticket transfer is available through My Passes.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <p>
        Some events carry age restrictions or require photo ID matching the name
        on the ticket. Always check the specific event page before you travel.
      </p>
    ),
  },
];
          ...
          <div className="bg-black text-white p-6 sm:p-8 mt-12 flex flex-col sm:flex-row sm:items-center justify-between gap-5">
            <div>
              ...
              <p className="text-white/60 text-sm mt-1">
                Report it and we'll investigate straight away.
              </p>
            </div>
            <a
              href="mailto:support@jazbatickets.com"
            ...
            >
              <Mail className="w-4 h-4" /> support@jazbatickets.com
            </a>
          </div>
        </div>
      </section>
