...
export default function Footer({ onScrollToSection, onSubscribe, onViewRefundPolicies, onViewTermsOfUse }: FooterProps) {
  ...
  return (
    <footer className="bg-neutral-50 border-t border-neutral-200/50 relative overflow-hidden" id="footer">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-14 pb-8 sm:px-6 md:px-8">
        <div className="bg-gradient-to-br from-[#E34718] to-[#C23A12] text-white rounded-[24px] p-6 sm:p-10 md:p-12 shadow-sm relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8 mb-16">
          ...
          <div className="relative z-10 max-w-md text-center md:text-left">
            ...
            {subscribed && (
              <div className="mt-4 inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm text-white px-4 py-1.5 rounded-full border border-white/10 font-bold text-xs animate-bounce" id="newsletter-success">
            ...
            {/* THE FORM INPUT PILL */}
            {!subscribed && (
              <form onSubmit={handleSubmit} className="mt-6 flex flex-col sm:flex-row items-center bg-white/95 backdrop-blur-sm rounded-full p-1 w-full gap-2 shadow-sm border border-black/5">
                <input 
                  type="email"
                  value={email}
          ...
          <div className="relative z-10 w-44 h-24 sm:w-56 sm:h-32 flex items-center justify-center shrink-0">
            ...
            <div className="absolute w-28 h-16 bg-rose-500 border border-rose-400 rounded-xl shadow-md rotate-[-12deg] flex items-center justify-center">
              <span className="text-[10px] font-black tracking-widest text-white select-none">★ ENTRY ★</span>
            </div>
            <div className="absolute w-28 h-16 bg-[#E34718] border border-[#C23A12]/30 rounded-xl shadow-md rotate-[15deg] flex items-center justify-center">
              <span className="text-[10px] font-black tracking-widest text-white select-none">★ PASS ★</span>
            </div>
            <div className="absolute bottom-1 right-2 bg-neutral-950 text-white px-2 py-0.5 rounded text-[8px] font-mono leading-none border border-white/10 font-bold">
              Verified
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-12 border-b border-neutral-200/50">
          ...
          <div className="md:col-span-4 flex flex-col gap-4">
            ...
            <p className="text-neutral-400 text-xs font-medium leading-relaxed max-w-sm">
              Jazbaticket is a global self-service ticketing platform for curated experiences, and shows. Fuel your cultural passion securely.
            </p>
          </div>
          ...
          <div className="md:col-span-6 grid grid-cols-2 sm:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-2 text-[11px] font-medium text-neutral-400">
                ...
                <li><button onClick={() => onScrollToSection('help')} className="hover:text-neutral-900 transition-colors text-left cursor-pointer">Cryptographic Gates</button></li>
